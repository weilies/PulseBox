...
export function ImportDialog({ fields, collectionSlug }: ImportDialogProps) {
 ...
 size="sm"
 variant="outline"
 className="gap-1.5 border-zinc-700/50 text-zinc-400 hover:border-gray-300 dark:border-gray-600 hover:text-blue-600 dark:hover:text-blue-400 dark:text-blue-400"
 />
 }
 >
 ...
 <DialogContent className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 shadow-[0_0_40px_rgba(0,240,255,0.15)] sm:max-w-2xl">
 <DialogHeader>
 <DialogTitle
 ...
 className="flex flex-col items-center justify-center w-full py-12 rounded-lg border-2 border-dashed border-zinc-700/50 hover:border-gray-300 dark:border-gray-600 transition-colors cursor-pointer group"
 >
 <FileSpreadsheet className="h-10 w-10 text-zinc-600 group-hover:text-blue-600 dark:hover:text-blue-400 dark:text-blue-400 transition-colors mb-3" />
 <p className="text-sm text-zinc-400 group-hover:text-blue-600 dark:hover:text-blue-400 dark:text-blue-400 transition-colors">
 ...
 >
 <SelectTrigger className="bg-gray-100 dark:bg-gray-800 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 h-8 text-xs">
 <SelectValue />
 </SelectTrigger>
