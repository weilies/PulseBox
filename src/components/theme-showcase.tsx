...
export function ThemeShowcase() {
 ...
 <p className="text-lg text-muted-foreground">Futuristic Dark Theme for PulseBox</p>
 </div>
 ...
 <div className="glow-card p-6 text-center">
 <div className="w-12 h-12 rounded bg-blue-50 dark:bg-blue-950 mx-auto mb-3 shadow-lg" style={{ boxShadow: '0 0 20px rgba(96, 165, 250, 0.8)' }} />
