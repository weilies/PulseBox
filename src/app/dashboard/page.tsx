...
export default async function DashboardPage() {
 ...
 <p className="text-gray-500 dark:text-gray-400" style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}>
 Here&apos;s your PulseBox overview.
 </p>
 </div>
 ...
 {/* Total Users Card */}
 <div
 className="rounded-2xl border border-gray-200 dark:border-gray-700 bg-gradient-to-br from-white dark:from-gray-900/40 to-gray-100 dark:to-gray-800/20 p-6 backdrop-blur-xl overflow-hidden relative group hover:border-blue-500/40 transition-all duration-300"
 style={{
 ...
 <h3
 className="text-sm font-semibold text-blue-500 dark:text-blue-400 uppercase tracking-wide"
 ...
 <p className="text-sm text-gray-500 dark:text-gray-400" style={{ fontFamily: "var(--font-geist-sans), sans-serif" }}>
 ...
 {/* System Status Card */}
 <div
 className="rounded-2xl border border-lime-400/20 bg-gradient-to-br from-white dark:from-gray-900/40 to-gray-100 dark:to-gray-800/20 p-6 backdrop-blur-xl overflow-hidden relative group hover:border-lime-400/40 transition-all duration-300"
 style={{
